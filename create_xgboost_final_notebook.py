...
# ========== MARKDOWN: Title ==========
md_title = """# 投球タイプ分類器（Pitch Identification Model）- XGBoost最終版
**作成日**: 2026/01/14  
...
# ========== SECTION 6: Ensemble ==========
md_section6 = """## 6. 最終モデル選択
XGBoost単体がアンサンブルより高精度のため、XGBoostを最終モデルとして採用します。"""

code_ensemble = """# === 最終モデル: XGBoost単体 ===
...
with open("asao_1324_xgboost_final.ipynb", "w") as f:
    nbf.write(nb, f)

print("Notebook 'asao_1324_xgboost_final.ipynb' created successfully!")
print(f"Total cells: {len(nb['cells'])}")
print("\\nSections:")
print("  0. ライブラリ読み込み")
print("  1. データ読み込み・概観")
print("  1.5. 探索的データ分析 (EDA)")
print("  2. 特徴量確認")
print("  3. データ準備")
print("  4. ベースラインモデル")
print("  5. GridSearch最適化")
print("  6. ★ 最終モデル選択 (XGBoost単体)")
print("  7. 分類レポート・混同行列")
print("  8. 特徴量重要度")
print("  9. SHAP分析")
print("  10. 誤分類分析")
